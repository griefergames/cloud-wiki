...
1. Halte das Forcefield-Flag-Recht in der Hand.
2. Mit Rechtsklick löst du das Item ein und aktivierst das Recht.

## Nutzung der Flag auf deinem Grundstück

* Mit dem Befehl `/p flag set forcefield true` aktivierst du die Forcefield-Flag
* Mit `/p flag set forcefield false` deaktivierst du die Forcefield-Flag
