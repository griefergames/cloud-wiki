...
Mit dem Farm-Sammler (Plot-Collector) können automatisch die generierten Items auf dem Grundstück eingelagert werden. Das reduziert die Anzahl an Trichtern, die für Farmen gebraucht werden.
...
Wenn man z.B. keine Items mehr benötigt oder etwas umbauen will, kann man nun den Drop vollständig deaktivieren. Die Farm wächst normal weiter, jedoch werden die Items nicht mehr gedroppt und nicht mehr eingesammelt, während der Drop deaktiviert ist.
...
{% hint style="info" %}
Standardmäßig ist der Drop immer aktiviert. Dieses Tool wird aber auch vom Team verwendet, um Drops von Farmen, die nicht aufgesammelt werden bzw. Spieler nicht mehr online sind, zu deaktivieren.
{% endhint %}
...
Für diesen Fall kann vom Team eine Verpflichtung für den Sammler hinterlegt werden. Das ist im Menü `/p collectors` dann wie folgt ersichtlich:
