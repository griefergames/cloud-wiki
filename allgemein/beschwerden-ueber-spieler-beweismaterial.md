...
Manchmal gibt es Situationen, die eure Spielerfahrung negativ beeinflussen. Solltet ihr einen Verstoß gegen unser [Regelwerk](https://griefergames.cloud/regelwerk) feststellen, habt ihr jederzeit die Möglichkeit, diesen bei uns zu melden.
...
Wir akzeptieren ausschließlich [Chat-Logs](#was-sind-chat-logs) und [Videoaufnahmen](#videoaufnahmen) als Beweismittel, welche nicht älter als 7 Tage sind. In besonderen Fällen können auch unbearbeitete Screenshots des gesamten Bildschirms relevant sein. Mehr Informationen dazu findet ihr in folgender Übersicht:
...
Habt ihr keinen [GGAuth-Account](griefergames-auth.md), könnt ihr zwar Chatlogs erstellen, sie jedoch nicht in eurem Account sichern. Ihr müsst dann nach dem Erstellen des Chatlogs den Link aus dem Chat separat speichern, damit ihr ihn für eine Meldung verwenden könnt.
...
{% hint style="success" %}
Über die Game Bar könnt ihr auch einstellen, dass automatisch dauerhaft die letzten X Sekunden aufgenommen werden, die ihr bei Bedarf speichern könnt. Diese Option benötigt etwas mehr Leistung und sollte daher nur auf performanten Systemen eingesetzt werden.
{% endhint %}
...
Nutzt ihr eine AMD-Grafikkarte, könnt ihr über die AMD-Software „Adrenalin“ ebenfalls Aufnahmen starten und direkt zu einem Anbieter (bspw. YouTube) hochladen.

{% hint style="success" %}
Über die Einstellung "Sofortige Wiedergabe" könnt ihr in der Adrenalin-Software einstellen, dass die letzten X Sekunden dauerhaft aufgenommen und per Hotkey gespeichert werden. Diese Option benötigt etwas mehr Leistung und sollte daher nur auf performanten Systemen eingesetzt werden.
{% endhint %}

#### OBS Studio und andere Programme
