...
Der Litematica-Printer ist lediglich für die Erstellung von Bauwerken erlaubt.
...
{% hint style="warning" %}
Mit aktivem Schulker-View-Perk sollte ebenfalls eine Einstellung vorgenommen werden. Mehr dazu ist unter [Perks](https://wiki.griefergames.live/funktionen/features/perks) zu lesen.
{% endhint %}
